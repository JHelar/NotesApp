...
class NoteDetailViewModel @Inject constructor(
    ...
    private var existingNoteCreated: LocalDateTime? = null
        ...
        savedStateHandle.get<Long>("noteId")?.let { existingNoteId ->
            ...
            viewModelScope.launch {
                noteDataSource.getNoteById(existingNoteId)?.let { note ->
                    ...
                    existingNoteCreated = note.created
                }
            }
        }
    }
            ...
            if (noteTitle.value.isNotEmpty() && noteContent.value.isNotEmpty()) {
                noteDataSource.insertNote(
                    Note(
                        ...
                        created = if (existingNoteCreated == null) DateTimeUtil.now() else existingNoteCreated!!
                    )
                )
            }
